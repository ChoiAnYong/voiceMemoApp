...
//OnboardingView가 메인 뷰 같은 역할이다
//메인 뷰 안에 담길 OnboardingContentView를 만들고 그에 하위 뷰를 만들어서 배치한다.
...
private struct OnboardingContentView: View {
    ...
    fileprivate init(onboardingViewModel: OnboardingViewModel) {//이게 private이면 OnboardingView에서 호출할 수 없다.
